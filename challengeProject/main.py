...
def create_app():
    ...
    def call_get_lender_reviews(lender_id=0):
        ...
        if vendor_type is None:
            raise ExceptionResponse("VendorType is a required parameter", 400)
